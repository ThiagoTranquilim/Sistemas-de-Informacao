...
void modificaBanda(tbandas bandas[]){
	int posicao, opcao;
	posicao = listaNome(bandas);
	if(posicao == -1){
		printf("Banda nao encontrada\n");
	...
	if(opcao == 1){
		...
		printf("Novo nome: ");
		fflush(stdin);
		gets(bandas[posicao].nome);
		printf("Novo genero: ");
		fflush(stdin);
		gets(bandas[posicao].genero);
		printf("Novos integrantes: ");
		scanf("%d", &bandas[posicao].integrantes);
		printf("Novo ranking: ");
		scanf("%d", &bandas[posicao].ranking);
		printf("----------------\n");		
	}else
		printf("Operacao cancelada\n");
}
...
int main(){
	...
	do{
		...
		switch (opcao){
			...
			case 7:
				printf("----------------\n");
				printf("Modifica Banda\n");
				printf("----------------\n");
				modificaBanda(bandas);
			case 0:
				printf("Saindo...\n");
				salvaArquivo(bandas);
			break;
